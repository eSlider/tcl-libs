...
LC_ALL=en_US exec /usr/local/bin/sigoswish "$0" ${1+"$@"}
...
#
# -------------------------------------------------------------------
proc string_replace { search replacement subjectVar  {count 0} } {
  upvar $subjectVar text
  return [string replace $text [set idx [string first $replacement $text]] [expr $idx+[string length $replacement]-1]]
}


set text "Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. \
